-- Keybinds.
--
-- Programs come from lib/programs.lua, generated by the NixOS module.
...
hl.bind(mod .. " + E",      hl.dsp.exec_cmd(p.files),       { description = "Files (yazi)" })
...
hl.bind(mod .. " + SHIFT + S", hl.dsp.exec_cmd("hyprshot --mode region --clipboard-only"), { description = "Screenshot region" })
hl.bind("Print",               hl.dsp.exec_cmd("hyprshot --mode output --clipboard-only"), { description = "Screenshot screen" })
